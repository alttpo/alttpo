...
class USROMMapping {
  ...
  array<SyncableItem@> @syncables = {
    ...
    @SyncableItem(0x354, 1, @mutateMax),
    @SyncableItem(0x355, 1, 1),
    @SyncableItem(0x356, 1, 1),
    @SyncableItem(0x357, 1, 1),
    @SyncableItem(0x359, 1, @mutateMax),
    @SyncableItem(0x35A, 1, @mutateMax),
    @SyncableItem(0x35B, 1, @mutateMax),
    @SyncableItem(0x35C, 1, @mutateMax),
    @SyncableItem(0x35D, 1, @mutateMax),
    @SyncableItem(0x35E, 1, @mutateMax),
    @SyncableItem(0x35F, 1, @mutateMax),
    @SyncableItem(0x364, 1, 2),
    @SyncableItem(0x365, 1, 2),
    @SyncableItem(0x366, 1, 2),
    @SyncableItem(0x367, 1, 2),
    @SyncableItem(0x368, 1, 2),
    @SyncableItem(0x369, 1, 2),
    @SyncableItem(0x370, 1, 1),
    @SyncableItem(0x371, 1, 1),
    @SyncableItem(0x374, 1, 2),
    @SyncableItem(0x379, 1, 2),
    @SyncableItem(0x37A, 1, 2),
    @SyncableItem(0x37B, 1, 1),
    @SyncableItem(0x3C5, 1, @mutateMax),
    @SyncableItem(0x3C6, 1, @mutateMax),
    @SyncableItem(0x3C7, 1, 1),
    @SyncableItem(0x3C9, 1, 2)
  };
};
